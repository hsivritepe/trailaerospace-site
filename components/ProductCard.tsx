...
export function ProductCard({
    ...
    return (
        <Link href={href} className="group block">
            <article className="product-card-bg relative min-h-[480px] overflow-hidden rounded-4xl border border-white/15 shadow-[0_24px_60px_rgba(0,0,0,0.12)]">
                <Image
                    src={imageSrc}
                    alt={imageAlt}
                    fill
                ...
                />
                <div
                    className="product-card-overlay absolute inset-0 opacity-90"
                    aria-hidden
                />
                <div className="absolute inset-x-0 bottom-0 p-5 sm:p-8">
                    <div className="grid gap-6 rounded-[1.75rem] border border-white/15 bg-black/50 p-6 backdrop-blur-md md:grid-cols-[1.1fr_0.9fr] md:items-end">
                        <div>
